...
const newsletterController = Container.get(NewsLetterController);

app.post("/newsletter/subscribe", (req: Request, res: Response, next: NextFunction) => newsletterController.subscribeToNewsletter(req, res, next))
